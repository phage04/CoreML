...
model.save('/Users/LyleJover/MyCape Drive/Personal/BlessingInThisGuy/CoreML/handwriting_model.h5')

import coremltools
coreml_model = coremltools.converters.keras.convert(model, input_names=['image'], image_input_names='image')

coreml_model.author = 'Lyle Jover'
...
coreml_model.save('/Users/LyleJover/MyCape Drive/Personal/BlessingInThisGuy/CoreML/handwritingModel.mlmodel')
